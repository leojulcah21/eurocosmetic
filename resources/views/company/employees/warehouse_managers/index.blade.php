            ...
            <div class="relative w-full p-12 overflow-hidden bg-white shadow-md sm:rounded-lg">
                <div
                    ...
                    <div
                        ...
                        <x-primary-link href="{{ route('company.employees.whs-managers.create') }}">
                            <x-slot:icon>
                        ...
                        <tbody>
                                ...
                                <td class="flex items-center justify-end px-4 py-3" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.away="open = false" x-transition
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button">
                                            <li>
                                                <button type="button"
                                                    onclick="window.location='{{ route('company.employees.sellers.edit', $whsManager) }}'"
                                            ...
                                            <li>
                                                <button type="button"
                                                    @click="$dispatch('open-delete-modal', { id: {{ $whsManager->id }} }); open = false"
                            ...
                            <tr>
                                <td colspan="8" class="px-4 py-3 text-center text-stone-800">
                                    No hay jefes de almacén registrados.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-400'">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white">
                            {{ $whsManagers->firstItem() }}
                        </span>
                        -
                        <span class="font-semibold text-gray-900 dark:text-white">
                            {{ $whsManagers->lastItem() }}
                        </span>
                        de
                        <span class="font-semibold text-gray-900 dark:text-white">
                            {{ $whsManagers->total() }}
                    ...
                    <div>
                        {{ $whsManagers->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </div>
        </x-app.data-section>
