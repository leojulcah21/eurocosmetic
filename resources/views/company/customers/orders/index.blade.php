                    ...
                    <table class="w-full text-sm text-left text-stone-700">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3">{{ $order->customer->user->email }}</td>
                                <td class="px-4 py-3">{{ $order->order_date->format('d/m/Y H:i') }}</td>
                                <td class="px-4 py-3">S/ {{ number_format($order->total_amount, 2) }}</td>
                                <td class="flex items-center justify-end px-4 py-3" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.away="open = false" x-transition
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button">
                                            <li>
                                                <button type="button"
                                                    onclick="window.location='{{ route('company.seller.customer.orders.update-status', $order) }}'"
