...
$variants = [
    ...
    'danger' => [
        'default' => [
            ...
            'p3' => 'text-stone-200 group-hover:text-red-200'
        ],
        'active' => [
            'p1' => 'text-red-600',
            'p2' => 'text-red-500',
...
<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-[15px] h-[15px] fill-current" aria-hidden="true"
...
-130 80 -19 37 -20 58 -20 370 0 312 1 333 20 370 37 73 124 99 200 60z" class="{{ $colors['p1'] }}" />
...
481 -4 788 -10 822 -34 180 -179 325 -359 359 -49 9 -2021 16 -2010 6z" class="{{ $colors['p3'] }}" />
...
82 -20 27 -1066 765 -1135 800 -43 23 -74 22 -126 -1z" class="{{ $colors['p2'] }}" />
            <path d="M2400 1280 l0 -680 239 0 c131 0 262 5 292 10 180 34 325 179 359
359 6 32 10 245 10 522 l0 469 -450 0 -450 0 0 -680z" class="{{ $colors['p3'] }}" />
        </g>
    </svg>
</div>
