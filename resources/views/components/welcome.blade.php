<div class="md:col-span-2 lg:col-span-1">
    <div class="h-full px-6 py-8 space-y-6 bg-white border border-gray-200 rounded-xl">
        ...
        <div>
            <h5 class="text-xl text-center text-gray-600">Global Activities</h5>
...
<div>
    <div class="h-full px-6 py-6 bg-white border border-gray-200 rounded-xl">
...
<div>
    <div class="px-6 py-8 text-gray-600 bg-white border border-gray-200 lg:h-full rounded-xl">
        ...
        <div class="mt-6">
            <h5 class="text-xl text-center text-gray-700">Ask to customize</h5>
            <div class="flex justify-center gap-4 mt-2">
