            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-stone-950 before:float-left before:pr-2 before:text-stone-950 before:content-['/']"
                            aria-current="page">{{ __('Dashboard') }}</li>
                    </ol>
                    {{ $header }}
                </nav>
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    ...
                    <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                        <li class="flex items-center">
                            <a href="#"
                                class="block px-0 py-2 text-sm font-semibold transition-all text-stone-950 ease-nav-brand">
                                <i class="fa fa-user sm:mr-1"></i>
                                <span class="hidden sm:inline">Sign In</span>
                            </a>
                        </li>
                        <li class="flex items-center pl-4 xl:hidden">
                            <a href="#" class="block p-0 text-sm text-white transition-all ease-nav-brand"
                                sidenav-trigger>
