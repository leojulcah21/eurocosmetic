...
<body class="m-0 font-sans text-base antialiased font-normal bg-[#f8f9fa] leading-[1.6] text-slate-500">
    ...
    <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-[17rem] rounded-xl z-10">
        <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 ml-6 transition-all ease-in shadow-none xl:mr-2 lg:mr-10 duration-250 rounded-2xl lg:flex-nowrap lg:justify-start md:mr-10">
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    <div class="flex items-center md:ml-auto md:pr-4">
                        <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg">
                            ...
                            <input type="text"
                                class="pl-9 text-sm w-[1%] leading-[1.4rem] relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-stone-300 bg-white bg-clip-padding py-2 pr-3 text-stone-700 transition-all placeholder:text-gray-500 focus:border-stone-500 focus:outline-none focus:transition-shadow"
                    ...
                    @guest
                        <ul class="flex flex-row justify-end pl-0 mb-0 -ml-1.5 list-none">
                            <li class="flex items-center">
                                <a href="#"
                                    class="relative flex flex-wrap px-4 py-2 text-sm font-semibold transition-all group hover:px-8 text-stone-950 hover:rounded-full hover:bg-red-100">
